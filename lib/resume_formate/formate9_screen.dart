...
class Formate9Screen extends StatefulWidget {
  final int index;
  const Formate9Screen({super.key, required this.index});

  @override
  State<Formate9Screen> createState() => _Formate9ScreenState();
}

class _Formate9ScreenState extends State<Formate9Screen> {
  List data = [];
  List educationdata = [];
  List experiencedata = [];
  List referencedata = [];
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: 20, right: e10),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                        ...
                        SizedBox(
                          ...
                          child: SliderTheme(
                            data: SliderTheme.of(context).copyWith(
                              activeTrackColor: AppColor.resumeskyColor,
                              trackHeight: 1,
...
//***************************************PDF Create*********************************** */
    ...
    return pw.Column(
      children: [
        pw.Container(
          height: 725,
          width: MediaQuery.of(context).size.width / 2,
          color: const PdfColor.fromInt(0xff110E0F),
          child: pw.Column(
            children: [
              pw.Padding(
              ...
              pw.Padding(
                ...
                child: pw.Container(
                  // height: 50,
                  width: double.infinity,
                  color: const PdfColor.fromInt(0xff23A4CF),
                  child: pw.Padding(
    ...
    return pw.Stack(
      children: [
        ...
        pw.Container(
          ...
          width: 10,
          decoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0xff23A4CF)),
        ),
      ],
    );
  }
  ...
  referenceDetails1() {
    return pw.Padding(
      padding: const pw.EdgeInsets.only(right: 20.0, left: 10),
      child: pw.Column(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
        children: [
          pw.Text(
