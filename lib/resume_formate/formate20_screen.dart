...
class Formate20Screen extends StatefulWidget {
  final int index;
  const Formate20Screen({super.key, required this.index});

  @override
  State<Formate20Screen> createState() => _Formate20ScreenState();
}

class _Formate20ScreenState extends State<Formate20Screen> {
  List data = [];
  List educationdata = [];
  List experiencedata = [];
  List referencedata = [];
          ...
          child: Stack(
            children: [
              Row(
                  ...
                  children: [designDetais(), contactDetais()]),
              Padding(
  ...
  Widget contactDetais() {
    return Expanded(
      child: Padding(
        padding: EdgeInsets.only(left: 10.h, bottom: 20.h, top: 100.h),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
      ...
      doc.addPage(pw.Page(
          ...
          build: (pw.Context context) {
            return pw.Container(
              ...
              child: pw.Stack(
                children: [
                  pw.Row(children: [designDetais2(), contactDetais2()]),
                  pw.Padding(
  ...
  designDetais2() {
    return pw.Expanded(
      child: pw.Container(
        ...
        child: pw.Padding(
          padding: pw.EdgeInsets.only(left: 10.w, bottom: 20.h),
          child: pw.Column(
  ...
  skillsDetails2() {
    return pw
      ...
      pw.Text(
        'SKILLS',
        style: pw.TextStyle(
            fontSize: 20.sp, color: const PdfColor.fromInt(0xFFFFFFFF)),
      ),
  ...
  contactDetais2() {
    return pw.Expanded(
      child: pw.Padding(
        padding: pw.EdgeInsets.only(left: 10.h, bottom: 20.h),
        child: pw.Column(
          mainAxisAlignment: pw.MainAxisAlignment.end,
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          children: [
