...
class Formate19Screen extends StatefulWidget {
  final int index;
  const Formate19Screen({super.key, required this.index});

  @override
  State<Formate19Screen> createState() => _Formate19ScreenState();
}

class _Formate19ScreenState extends State<Formate19Screen> {
  List data = [];
  List educationdata = [];
  List experiencedata = [];
  List referencedata = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: AppColor.resumeBlackColor,
    ...
    return Column(
      ...
      children: [
        Text(
          'LANGUAGES',
          style: AppTheme.of(context).bodyText1.override(
              fontSize: 20, fontWeight: FontWeight.w600, color: headText),
        ),
  ...
  contactDetais2() {
    return pw.Expanded(
      child: pw.Padding(
        padding: pw.EdgeInsets.only(left: 10.w, top: 20.h),
        child: pw.Column(
