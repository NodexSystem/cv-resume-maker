...
class Formate22Screen extends StatefulWidget {
  final int index;
  const Formate22Screen({super.key, required this.index});

  @override
  State<Formate22Screen> createState() => _Formate22ScreenState();
}

class _Formate22ScreenState extends State<Formate22Screen> {
  List data = [];
  List educationdata = [];
  List experiencedata = [];
  List referencedata = [];
  ...
  Widget topContainer() {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColor.appBlackColor),
      child: Padding(
  ...
  contactDetais2() {
    return pw.Padding(
      padding: pw.EdgeInsets.only(left: 20.w, top: 60.h),
      child: pw.Container(
