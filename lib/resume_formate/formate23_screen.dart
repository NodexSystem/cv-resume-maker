...
import '../components/apptheam.dart';

import 'package:pdf/pdf.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:printing/printing.dart';

class Formate23Screen extends StatefulWidget {
  final int index;
  const Formate23Screen({super.key, required this.index});

  @override
  State<Formate23Screen> createState() => _Formate23ScreenState();
}

class _Formate23ScreenState extends State<Formate23Screen> {
  List data = [];
  List educationdata = [];
  List experiencedata = [];
  List referencedata = [];
  ...
  Color destextcolor = AppColor.appBlackColor;
  ...
  Widget contactDetais() {
    return Expanded(
      child: Container(
        decoration: BoxDecoration(color: AppColor.resumelightpinkColor),
      ...
      doc.addPage(pw.Page(
          ...
          build: (pw.Context context) {
            return pw.Container(
                ...
                child: pw.Row(children: [contactDetais2(), designDetais2()]));
          }));
  ...
  contactDetais2() {
    return pw.Expanded(
      child: pw.Container(
        decoration: pw.BoxDecoration(
          color: PdfColor.fromInt(0xffE4B4B4),
        ),
        height: 724,
        width: MediaQuery.of(context).size.width / 2,
        child: pw.Padding(
          padding: pw.EdgeInsets.only(left: 10.w, top: 30.h),
          child: pw.Column(
            children: [
              pw.Container(
                height: 200,
  ...
  designDetais2() {
    return pw.Expanded(
      child: pw.Padding(
        padding: pw.EdgeInsets.only(left: 10.w, top: 30.h, right: 10.w),
        child: pw.Column(
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          ...
          children: [
            ...
            pw.Text(
              "CONTACT INFO ",
              style: pw.TextStyle(
                  fontSize: 15.sp, color: PdfColor.fromInt(testingColorValue!)),
            ),
            pw.SizedBox(height: 10.h),
            pw.Text(
              "PHONE",
              style: pw.TextStyle(
                  fontSize: 10.sp, color: PdfColor.fromInt(testingColorValue!)),
            ),
            pw.Text(
              contactNumber,
              style: pw.TextStyle(
